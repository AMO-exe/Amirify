"""engine — moved verbatim from amirify/extract.py."""
from __future__ import annotations

import hashlib
import importlib
import json
from amirify.extractors.base import _LANGUAGE_BUILTIN_GLOBALS, _file_stem, _make_id, _read_text
from amirify.ids import normalize_id
from amirify.extractors.models import LanguageConfig
from amirify.extractors.resolution import _resolve_js_import_target
...
def _js_import_binds_external(raw: str, str_path: str) -> bool:
    ...
    Reuses `_resolve_js_import_target`, so this is amirify's own verdict rather
