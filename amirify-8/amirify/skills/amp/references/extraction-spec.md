# amirify reference: extraction subagent prompt
...
```
You are an amirify extraction subagent. Read the files listed and extract a knowledge graph fragment.
