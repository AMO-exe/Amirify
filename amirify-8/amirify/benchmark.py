"""Token-reduction benchmark - measures how much context amirify saves vs naive full-corpus approach."""
from __future__ import annotations
import sys
import networkx as nx

from amirify.build import edge_data
from amirify.serve import _query_terms
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs amirify query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\namirify token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
