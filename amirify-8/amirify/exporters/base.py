"""Shared constants/helpers for the amirify exporters package.

Symbols used by more than one exporter live here so each exporter module can be
split out of amirify/export.py without a circular import (export.py and the
...
# Obsidian exporters. Moved verbatim from amirify/export.py.
COMMUNITY_COLORS = [
