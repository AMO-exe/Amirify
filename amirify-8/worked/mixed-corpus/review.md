# Amirify Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three amirify modules map cleanly
...
detect() on eval root with amirify-out/memory/ present:
...
**What amirify extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
identically to English. The image node in amirify is just a path - the vision subagent does
the rest.
