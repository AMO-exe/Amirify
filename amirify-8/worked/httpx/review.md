# Amirify Evaluation - httpx Corpus (2026-04-03)
...
**Pipeline:** amirify AST extractor + graph_builder + Leiden clusterer + analyzer + reporter
**Method:** Full deterministic code tracing of every amirify source module against
...
The amirify AST extractor is deterministic, fast, and accurate for what it extracts.
