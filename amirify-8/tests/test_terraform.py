"""Tests for the Terraform/HCL extractor (amirify/extract.py, issue #187)."""
from __future__ import annotations

from pathlib import Path

from amirify.build import build_from_json
from amirify.extract import extract_terraform
...
def test_terraform_attributes_context_rendering(tmp_path):
    from amirify.serve import _subgraph_to_text
...
def test_terraform_attributes_round_trip_serialization(tmp_path):
    ...
    from amirify.serve import _load_graph
