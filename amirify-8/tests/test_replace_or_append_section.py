"""#1688 - amirify's shared-file section update must not destroy user content.

_replace_or_append_section used to locate its marker (`## amirify`) as a
...
from amirify.__main__ import _replace_or_append_section

MARKER = "## amirify"
NEW = "## amirify\n\nThis project has a knowledge graph at amirify-out/.\n"
...
def test_real_section_is_replaced_in_place():
    ...
    assert "knowledge graph at amirify-out/" in after
