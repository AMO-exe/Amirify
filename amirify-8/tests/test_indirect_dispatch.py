...
from amirify.affected import affected_nodes
from amirify.extract import extract, extract_python
...
def test_cross_file_indirect_survives_id_relativization(tmp_path):
    ...
    root, as the `amirify extract` CLI passes), the id-remap rewrites node ids
