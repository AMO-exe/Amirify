...
directory therefore overruns MAX_PATH, and `amirify export obsidian` /
...
from amirify import export as export_mod
from amirify import wiki as wiki_mod
from amirify.export import _obsidian_safe_stem, to_canvas, to_obsidian
from amirify.paths import _MIN_STEM_BUDGET, _WINDOWS_MAX_PATH, stem_filename_budget
from amirify.wiki import _safe_filename, to_wiki
...
def test_budget_shrinks_so_the_whole_path_fits_max_path(monkeypatch):
    ...
    vault = r"C:\Users\dev\projects\payments-api\amirify-out\obsidian"
