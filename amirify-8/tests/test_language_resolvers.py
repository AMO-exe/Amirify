"""Tests for the language resolver registry (amirify.resolver_registry).
...
from amirify.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import amirify.extract  # noqa: F401  (registers resolvers on import)
