...
Papers are the longest documents anyone points amirify at, and a compressed
...
from amirify.llm import _FILE_CHAR_CAP, _file_to_text, _read_files

try:  # the reader this fix introduces
    from amirify.file_slice import unit_source_text
