...
Example output:
    === Amirify AST Extraction Benchmark ===
    Files:        1,247
...
from amirify.extract import extract, collect_files
from amirify.cache import clear_cache
...
def main() -> None:
    ...
    print("=== Amirify AST Extraction Benchmark ===\n")
