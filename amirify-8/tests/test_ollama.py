"""Tests for the Ollama backend additions in amirify/llm.py."""
from __future__ import annotations

import pytest

from amirify.llm import detect_backend, BACKENDS, _validate_ollama_base_url
...
def test_ollama_api_key_sentinel(monkeypatch):
    ...
    with patch("amirify.llm._call_openai_compat", return_value=fake_result) as mock_call:
        from amirify.llm import extract_files_direct
