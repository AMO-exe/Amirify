...
Both callers now delegate to :mod:`amirify.ids`, so they share one
...
from amirify.build import _normalize_id
from amirify.extract import _make_id
from amirify.ids import make_id, normalize_id
...
def test_both_callers_share_one_implementation():
    ...
    underlying function object as amirify.ids.normalize_id."""
    # build._normalize_id is imported directly from amirify.ids.
    ...
    from amirify.mcp_ingest import _make_id as _mcp_make_id
    from amirify.symbol_resolution import _bash_make_id
