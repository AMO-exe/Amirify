...
affected.load_graph (`amirify prs`), and diagnostics._read_json_file
(`amirify diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from amirify.diagnostics import _read_json_file
