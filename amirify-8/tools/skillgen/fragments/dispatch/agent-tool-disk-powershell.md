...
```powershell
$PROJECT_ROOT = (Get-Location).Path  # cwd — where Part C globs amirify-out\ (NOT .amirify_root/scan dir, #1392)
# Then for chunk N: $CHUNK_PATH = Join-Path $PROJECT_ROOT "amirify-out\.amirify_chunk_0N.json"
```
